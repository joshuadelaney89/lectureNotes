...
/*
Null and undefined both represent variables with no value inside. Think of it this way--null values are for gag gifts that are boxes intentionally given with nothing inside (because that's the gag). Undefined values are gifts given when the person giving the gift has forgotton to put the gift inside (oops!).
*/
...
//Strings
//String is ay value within quotes. JS spits out the value within the quotes
...
var stepsBrushTeeth = ['uncap toothpaste', 'squeeze toothpaste', 'rinse brush', 'brush', 'clean brush'];
//array indexing        0                    1                     2               3         4
//array indexing starts at 0
console.log(stepsBrushTeeth);

console.log(stepsBrushTeeth [2]);